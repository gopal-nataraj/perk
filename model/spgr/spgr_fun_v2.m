  function [ss] = spgr_fun_v2(M0, T1, T2, flip, TR, TE, varargin)
%|function [ss] = spgr_fun_v2(M0, T1, T2, flip, TR, TE, varargin)
%|
%|  spoiled gradient-recalled echo steady state signal model
...
ss = spgr_gen(M0, T1, T2, kap, dw, R2p, flip, TR, TE);
