  function [ss_grad] = spgr_gradx(M0, T1, T2, flip, TR, TE, varargin)
%|function [ss_grad] = spgr_gradx(M0, T1, T2, flip, TR, TE, varargin)
%|
%|  spoiled gradient-recalled echo signal gradient
...
%|
%|  outputs
%|	  ss_grad   [(odims) L]     spgr signal gradient at t=TE after RF
%|
