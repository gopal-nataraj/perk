...
rff.len.nu = [];
rff.c = 2^0.6;
rff.H = 10^2; % paper used 10^3, if you have the memory...
rff.K = 10^4; % paper used 10^5, if you have the memory...
inv.krr = 2^-30; % paper used 2^-41, but with only 10^4 samples this may yield inaccurate results
bool.mag.ir = 0;
bool.mag.se = 0;
bool.mag.sp = 1;
bool.mag.de = 1;
